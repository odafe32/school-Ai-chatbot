        ...
        <div class="max-w-md w-full space-y-8 relative">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 backdrop-blur-sm">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Submit Button -->
                    <div class="pt-4">
                        <x-primary-button class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-lg text-sm font-semibold text-white bg-green-700 hover:bg-    green-500 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]">
                ...
                <a class="text-sm font-medium flex justify-center items-center w-full pt-5 text-green-600 hover:green-indigo-500 transition-colors duration-200 hover:underline"
                   href="{{ route('login') }}">
            ...
            <div class="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
                <div class="absolute -top-40 -right-40 w-80 h-80 bg-green-700  rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
                <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-green-600 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style="animation-delay: 2s;"></div>
            </div>
        </div>
    </div>
